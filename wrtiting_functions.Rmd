...
Check that this works. This does the same thing instead of writing out the code, we are applying the function to the result.
...
# generates a new sample everytime
...
lotr_load_and_tidy = function(path = "data/LotR_Words.xlsx", cell_range, movie_name) {
 # all the work is happening in the function 
  movie_df = 
